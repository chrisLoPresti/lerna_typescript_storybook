...
var PanelWrapper = _theming.styled.div({
  height: '100%',
  overflow: 'auto',
  width: '100%'
});
...
function (_PureComponent) {
  ...
  function KnobPanel(props) {
        ...
        Object.keys(knobs).forEach(function (name) {
          ...
          if (!_this.loadedFromUrl) {
            ...
            if (urlValue !== undefined) {
              ...
              channel.emit(_shared.CHANGE, knob);
            }
    ...
    _this.emitChange = function (changedKnob) {
      var channel = _this.props.channel;
      channel.emit(_shared.CHANGE, changedKnob);
    };
    ...
    _this.handleClick = function (knob) {
      var channel = _this.props.channel;
      channel.emit(_shared.CLICK, knob);
    };
  ...
  _createClass(KnobPanel, [{
    ...
    value: function componentDidMount() {
      ...
      channel.on(_shared.SET, this.setKnobs);
      channel.on(_shared.SET_OPTIONS, this.setOptions);
    ...
    value: function componentWillUnmount() {
      ...
      channel.removeListener(_shared.SET, this.setKnobs);
    ...
    value: function render() {
      ...
      return _react.default.createElement(PanelWrapper, null, entries.length > 1 ? _react.default.createElement(_components.TabsState, null, entries.map(function (_ref5) {
