...
function (_Component) {
  ...
  function Tooltip() {
    ...
    _this.handleOutsideClick = function (event) {
      if (!reactDom.findDOMNode(_assertThisInitialized(_assertThisInitialized(_this))).contains(event.target)) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    observer.observe(reactDom.findDOMNode(this), MUTATION_OBSERVER_CONFIG);
